...
const cluesJSONString = `[
    ...
    ["Freeloader thesis mate",
    "Reliable thesis mate"],
    ...
    ["Empty attendance class",
    "Worth-it attendance class"],
    ...
    ["7:30 AM class struggle",
    "11:30 AM class blessing"],
    
    ["Heavy finals week",
    "Manageable finals week"],
    
    ["Unreadable readings",
    "Actually useful readings"],
    
    ["All-nighter before exam",
    "Chill review before exam"],
    ...
    ["Empty bleachers",
    "Full Blue Eagle crowd"],
    
    ["Rainy Katip commute",
    "Smooth Katip commute"],
    
    ["Traffic to campus",
    "Clear Katip traffic"],
    
    ["Overpriced Katip food",
    "Sulit Katip food"],
    ...
    ["Bad reporting group",
    "Smooth reporting group"],
    
    ["Unclear prof instructions",
    "Crystal clear syllabus"],
    
    ["Lost in campus",
    "Campus master navigator"],
    
    ["First day anxiety",
    "First day excitement"],
    
    ["No friends in class",
    "Instant college barkada"],
    
    ["Worst friend in college",
    ...
    ["Identity crisis in college",
    "Clear life direction"],
    
    ["Just surviving college",
    "Thriving in Ateneo"]
]`;
